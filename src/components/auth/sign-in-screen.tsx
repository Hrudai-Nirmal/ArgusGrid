/**
 * Sign-in screen with OAuth and email/password entry points.
 */
...
/**
 * Renders resilient Meridian sign-in entry points.
 */
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="flex flex-col gap-3">
          ...
          <div className="grid gap-2 rounded-lg border bg-muted/20 p-3">
            ...
            {credentialsMessage ? <p className="text-xs text-muted-foreground" role="status">{credentialsMessage}</p> : null}
          </div>
