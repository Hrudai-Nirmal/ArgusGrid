...
- Click `Test INR 1 payment`; confirm the Razorpay modal opens with the low-value checkout path, safe customer prefill, and the card method preferred where Razorpay supports method preselection.
