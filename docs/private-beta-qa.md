...
- In the public Automation Map section, drag a demo node and confirm it swaps position with the nearest slot without opening any real Meridian graph controls.
